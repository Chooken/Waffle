...
public static class Script
{
    ...
    public static Tag FromString(string str)
    {
        ...
        return new Tag { Value = (uint)HarfBuzz.hb_script_from_string(bytes, bytes.Length) };
    }
    ...
    {
        return new Tag { Value = (uint)HarfBuzz.hb_script_from_iso15924_tag((int)tag.Value) };
    }
