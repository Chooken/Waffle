...
namespace WaffleEngine
{
    public static class Keyboard
    {
        ...
        public static bool IsPressed(Keycode key) => Window.CurrentKeyboardState.IsKeyPressed((Keys)key);

        public static bool IsDown(int key) => Window.CurrentKeyboardState.IsKeyDown((Keys)key);
        public static bool IsDown(Keycode key) => Window.CurrentKeyboardState.IsKeyDown((Keys)key);
    }
