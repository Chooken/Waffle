...
namespace WaffleEngine
{
    public abstract class UIElement
    {
        ...
        public int GetWidthInPixels() => (int)System.Math.Round((Width / 100) * Window.RenderWidth);
        public int GetHeightInPixels() => (int)System.Math.Round((Height / 100) * Window.RenderHeight);
